...
#             "description": f"Le sommet {node} est ajouté à la composante courante.",
#             "state": {
...
#                 steps.append({
#                     "title": f"Exploration de {node} vers {neigh}",
#                     "description": f"On explore l’arête entre {node} et {neigh}.",
#                     "state": {
#                         "visited_nodes": list(visited),
#                         "selected_nodes": list(comp),
...
#                 "description": f"Début d’une nouvelle composante à partir de {node}.",
#                 "state": {
#                     "visited_nodes": list(visited),
#                     "selected_nodes": [],
#                     "highlighted_nodes": [node],
...
#     """Run connected components algorithm with proper response format."""
